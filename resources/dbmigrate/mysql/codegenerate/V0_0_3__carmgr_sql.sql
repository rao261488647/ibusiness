...
delete from IB_MENU where ID='carmgrmTwo5';
INSERT INTO IB_MENU(ID,MENUNAME,MENULEVEL,MENUURL,MENUIFRAME, MENUORDER,PARENTID) VALUES('carmgrmTwo5','停车场出入库管理','2','/parkinglot/parkinglot-list.do','URL','5','carmgrmOne1');
...
INSERT INTO IB_MENU_ROLE_DEF(MENU_ID,ROLE_DEF_ID) VALUES('carmgrmTwo5','2');
/* ================================================================================   */
/* ================================  车库管理表    =================================   */
/* ================================================================================   */
/* ====== 车库信息管理 =====  */
...
/* ================================================================================   */
/*======= 创建表 ==========*/
DROP TABLE IF EXISTS IB_PARKINGLOT;
CREATE TABLE IB_PARKINGLOT (TYPENAME VARCHAR(32), CARNUM VARCHAR(16), ININFO VARCHAR(64), INTIME DATETIME, INMIL VARCHAR(16), OUTINFO VARCHAR(64), OUTIME DATETIME, OUTMIL VARCHAR(16), ID VARCHAR(64), SCOPEID VARCHAR(64),  PRIMARY KEY (ID)) ENGINE=INNODB;
/*======= 表单 ==========*/
 delete from ib_conf_form where FORMNAME='PARKINGLOT';
 insert into ib_conf_form(ID,PACKAGENAME,FORMNAME,FORMTITLE,FORMURL, ISEDIT,ISADD,ISDELETE,ISQUERY,ISEXCELEXPORT,ISIMPORTEXPORT,ISBPMFORM) values ('b3b80247-6d42-4fe4-9511-9ed6e2652f72','carmgr','PARKINGLOT','停车场出入库管理','/parkinglot/parkinglot-list.do',1,1,1,1,1,2,2);
/*======= 表单对应表 ==========*/
 delete from ib_conf_form_table where FORMNAME='PARKINGLOT';
insert into ib_conf_form_table(PACKAGENAME,FORMNAME,TABLENAME,TABLETYPE) values ('carmgr','PARKINGLOT','IB_PARKINGLOT','main');
/*======= 表单字段 ==========*/
 delete from ib_conf_form_table_colums where FORMNAME='PARKINGLOT';
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.TYPENAME','型号名称','TYPENAME','IB_PARKINGLOT',1,'10','','','1','1','1','1','','{"jsplist":[{"inputKey":"typename","inputValue":"typename","inputTitle":"车型名称"},{"inputKey":"carnum","inputValue":"carnum","inputTitle":"车牌号"}],"className":"IB_CAR_MGR","queryTitle":"车牌号","queryName":"carnum"}');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.CARNUM','车牌号','CARNUM','IB_PARKINGLOT',2,'1','','','1','1','2','','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.ININFO','入库原因','ININFO','IB_PARKINGLOT',3,'2','','','1','1','2','1','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.INTIME','入库时间','INTIME','IB_PARKINGLOT',4,'3','','','1','1','2','1','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.INMIL','入库里程','INMIL','IB_PARKINGLOT',5,'5','','','1','1','2','1','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.OUTINFO','出库原因','OUTINFO','IB_PARKINGLOT',6,'2','','','1','1','2','2','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.OUTIME','出库时间','OUTIME','IB_PARKINGLOT',7,'3','','','1','1','2','2','','');
insert into ib_conf_form_table_colums(PACKAGENAME,FORMNAME,FORMCOLUMN,FORMCOLUMNTITLE,TABLECOLUMN, TABLENAME,COLUMNNO,FCTYPE,FCWIDTH,FCHEIGHT,FCDISPLAY,FCEDIT,FCQUERY,FCMUST,FCDEFAULT, CONFSELECTINFO) values ('carmgr','PARKINGLOT','IB_PARKINGLOT.OUTMIL','出库里程','OUTMIL','IB_PARKINGLOT',8,'5','','','1','1','2','2','','');
/*======= 表 ==========*/
 delete from ib_conf_table where TABLENAME='IB_PARKINGLOT';
insert into ib_conf_table(ID,PACKAGENAME,TABLENAME,TABLENAMECOMMENT,TABLETYPE, PARENTTABLEID,ISBPMTABLE) values ('b4f6685d-dc90-4a0f-b1f6-fcbdb8e5c87b','carmgr','IB_PARKINGLOT','停车场出入库管理','1','null',2);
/*======= 表字段 ==========*/
 delete from ib_conf_table_columns where TABLENAME='IB_PARKINGLOT';
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','TYPENAME','型号名称','VARCHAR','32','是','',1);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','CARNUM','车牌号','VARCHAR','16','是','',2);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','ININFO','入库原因','VARCHAR','64','是','',3);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','INTIME','入库时间','DATE','0','是','',4);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','INMIL','入库里程','VARCHAR','16','是','',5);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','OUTINFO','出库原因','VARCHAR','64','是','',6);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','OUTIME','出库时间','DATE','0','是','',7);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','OUTMIL','出库里程','VARCHAR','16','是','',8);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','ID','UUID主键','VARCHAR','64','否','',91);
insert into ib_conf_table_columns(tableName,columnValue,columnName,columnType,columnSize, isNull,defaultValue,columnNo) values ('IB_PARKINGLOT','SCOPEID','范围','VARCHAR','64','否','',92);

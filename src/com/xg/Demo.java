...
import com.xg.outerlib.org.json.JSONObject;
import com.xg.src.com.tencent.xinge.ClickAction;
import com.xg.src.com.tencent.xinge.Message;
import com.xg.src.com.tencent.xinge.MessageIOS;
import com.xg.src.com.tencent.xinge.Style;
import com.xg.src.com.tencent.xinge.TagTokenPair;
import com.xg.src.com.tencent.xinge.TimeInterval;
 ...
 */
public class Demo {
	private static String accessId = "2100177474";
	private static String accessKey = "A6HW75YEP58I";
    private static String secretKey = "f78f4286e17cfe74215a9913bce06b2a";
	public static void main(String[] args) {
		// 易用接口
		System.out.println(XingeApp.pushTokenAndroid(2100177474, secretKey, "标题坤坤test1", "pushTokenAndroid坤坤测试推送信息内容", "79081efa413fbdc24a73a7afbd8793791198b455"));
		// System.out.println(XingeApp.pushAccountAndroid(000, "secretKey",
		// "test", "测试", "account"));
		// secretKey：后台接口鉴权密钥 TODO  AccessId：推送目标应用的ID (000)
		 System.out.println(XingeApp.pushAllAndroid(2100177474, secretKey, "标题坤坤test1", "pushAllAndroid坤坤测试推送信息内容"));
		...
		// XingeApp.IOSENV_DEV));
		// System.out.println(XingeApp.pushTagIos(000L, "secretKey", "测试",
		// "tag", XingeApp.IOSENV_DEV));
...
//		 System.out.println("ret:" + ret.toString());
	...
	protected JSONObject demoPushAllDevice() {
		XingeApp xinge = new XingeApp(000, secretKey);
	...
	protected JSONObject demoPushAccountListMultiple() {
		...
		if (ret.getInt("ret_code") != 0)
			...
			// ...
			result.append("all", xinge.pushAccountListMultiple(ret
					.getJSONObject("result").getInt("push_id"), accountList1));
			...
			// ...
			result.append("all", xinge.pushAccountListMultiple(ret
					.getJSONObject("result").getInt("push_id"), accountList2));
			return (result);
		}
	}
	...
	protected JSONObject demoPushDeviceListMultiple() {
		...
		if (ret.getInt("ret_code") != 0)
			...
			// ...
			result.append("all", xinge.pushDeviceListMultiple(ret
					.getJSONObject("result").getInt("push_id"), deviceList1));
			...
			// ...
			result.append("all", xinge.pushDeviceListMultiple(ret
					.getJSONObject("result").getInt("push_id"), deviceList2));
			return (result);
		}
	}
	...
	protected JSONObject DemoBatchSetTag() {
		...
		pairs.add(new TagTokenPair("tag1",
				"token00000000000000000000000000000000001"));
		pairs.add(new TagTokenPair("tag2",
				"token00000000000000000000000000000000001"));

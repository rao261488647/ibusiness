 ...
 */
@Service
public class ServiceRequestWx implements IServiceRequest{ 
    ...
    public ServiceRequestWx() throws UnrecoverableKeyException, KeyManagementException, NoSuchAlgorithmException, KeyStoreException, IOException {
        init();
    }
    ...
    public String sendPost(String url, Object xmlObj) throws IOException, KeyStoreException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException {
        ...
        if(postDataXML.contains("com.jumi.webservice.weixin.model.WxPayQueryReq")){
        	postDataXML=postDataXML.replace("com.jumi.webservice.weixin.model.WxPayQueryReq", "xml");
        }

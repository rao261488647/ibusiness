...
public class WxPayRes {
    ...
    private String coupon_batch_id_n; // 代金券或立减优惠批次ID
    private String coupon_id_n; // 代金券或立减优惠ID
    private String coupon_fee_n; // 单个代金券或立减优惠支付金额
	...
	public String getCoupon_batch_id_n() {
		return coupon_batch_id_n;
	}
	public void setCoupon_batch_id_n(String coupon_batch_id_n) {
		this.coupon_batch_id_n = coupon_batch_id_n;
	}

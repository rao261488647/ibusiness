...
<html>
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="illegal-list.do" class="form-inline">
				    <div class="form-group">
				                <label for="code_table_carnum">车牌号码:</label>
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">违章管理列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="illegal-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="illegal-remove.do" class="m-form-blank">
			      ...
			      <thead>
				      <tr>
				        <th width="30" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
					                ...
					                <th class="sorting">违章时间</th>
					                <th class="sorting">罚款金额</th>
					                <th class="sorting">处理方式</th>
					                <th class="sorting">费用方式</th>
					                <th class="sorting">是否扣分</th>
					    ...
					    <tbody>
					      ...
					      <tr class="${status.index%2==1? 'active':''}">
					        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.id}"></td>
						            ...
						            <td>${item.points}</td>
					        <td>
					          <a href="illegal-input.do?id=${item.id}" class="a-update" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-pencil"></span></a>
					        </td>
					      </tr>
					      </c:forEach>
					    </tbody>

...
<html>
  <head>
    ...
    <title>车辆借出管理编辑</title>
    <%@include file="/common/center.jsp"%>
  </head>
  <body>
    <script type="text/javascript">
		$(function() {
			$.validator.addMethod('backdateCheck', function(value, element) {
				var statusValue = $('select[name=status]').val();
				if (statusValue == '已归还') {
					if ($("#code-backdate").val()== null || $("#code-backdate").val()== "") {
						return false;
					} else {
						return true;
					}
    ...
    <div class="panel panel-default col-lg-12 col-md-12 col-sm-12"> 
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">车辆借出管理编辑</h4></div>
                ...
                <form id="cgForm" method="post" action="save.do" class="form-horizontal">
                  <c:if test="${model != null}">
                      <input id="code_id" type="hidden" name="id" value="${model.id}">
                          ...
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label" for="code-date">日期:</label>
                          <div class="col-lg-3 col-md-3 col-sm-3">   <div class="input-append datepicker date">  <span class="add-on">    <input id="code-date" type="text" name="date" value="<fmt:formatDate value="${model.date}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />" placeholder="点击选择" class="form-control input-sm required" readonly >  </span>  </div></div>
                          
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label" for="code-specialname">借车人:</label>
                          <div class="col-lg-3 col-md-3 col-sm-3">    <input id="code-specialname" type="text" name="specialname" value="${model.specialname}" class="text form-control input-sm "  ></div>
                          ...
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label" for="code-loandate">借出日期:</label>
                          <div class="col-lg-3 col-md-3 col-sm-3">    <div class="input-append datepicker date">  <span class="add-on">    <input id="code-loandate" type="text" name="loandate" value="<fmt:formatDate value="${model.loandate}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />" placeholder="点击选择" class="form-control input-sm required" readonly >  </span>  </div></div>
                          ...
                          <label class="col-lg-2 col-md-2 col-sm-2 control-label" for="code-backdate">还回日:</label>
                          <div class="col-lg-3 col-md-3 col-sm-3">    <div class="input-append datepicker date">  <span class="add-on">    <input id="code-backdate" type="text" name="backdate" value="<fmt:formatDate value="${model.backdate}" type="both" dateStyle="long" pattern="yyyy-MM-dd" />" placeholder="点击选择" class="form-control input-sm backdateCheck" readonly >  </span>  </div></div>

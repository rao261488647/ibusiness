...
<html>
  ...
  <body>
	...
	<!-- 查询条件 -->
        <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">查询</h4></div>
          <div class="panel-body">
	          <div id="search" class="content content-inner">
				  <form name="cgForm" method="post" action="count5.do" class="form-inline">
	   ...
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">维修保养周统计表</h4></div>
	   <div class="content">
<table class="table table-bordered" style="width:60%">
   <tbody>
	...
	$('#exportBtn').click(function(){
		...
		var url = '${ctx}/count/exportcount5.do?filter_GED_date=' + $('#code-eventdate').val();
		window.open(url);
	});
    </script>
</html>

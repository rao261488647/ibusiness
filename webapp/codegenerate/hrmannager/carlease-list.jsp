...
<html>
  ...
  <body>
	...
	<!-- 查询条件 -->
	   <div class="panel-heading"><h4 class="panel-title glyphicon glyphicon-paperclip">以租代购列表</h4></div>
       <div class="panel-body">
		    <div class="pull-left">
			    <button class="btn btn-primary btn-sm a-insert" href="carlease-input.do" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-tasks"></span>新建</button>
	   ...
	   <div class="content">
			<form id="gridForm" name="gridForm" method='post' action="carlease-remove.do" class="m-form-blank">
			      ...
			      <thead>
				      <tr>
				        <th width="30" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
					                ...
					                <th class="sorting">签约日期</th>
					                <th class="sorting">首付金额</th>
					                <th class="sorting">签约期数</th>
					                <th class="sorting">第一次月供</th>
					                <th class="sorting">第二次月供</th>
				        <th width="30">&nbsp;</th>
				      </tr>
				    </thead>
					    <tbody>
					      ...
					      <tr class="${status.index%2==1? 'active':''}">
					        ...
					        <td>
					          <a href="carlease-input.do?id=${item.id}" class="a-update" data-target="#modalInput" data-toggle="modal" data-database="true"><span class="glyphicon glyphicon-pencil"></span></a>
					        </td>
					      </tr>
					      </c:forEach>
					    </tbody>
